...
[![Image from Gyazo](https://i.gyazo.com/c4062f93bee2e0d864b0acda86790c7e.gif)](https://gyazo.com/c4062f93bee2e0d864b0acda86790c7e)
---
...
```bash
git clone https://github.com/kanoko-west/director_assistant_2.git
cd director_assistant_2
bundle install
bin/rails db:create
